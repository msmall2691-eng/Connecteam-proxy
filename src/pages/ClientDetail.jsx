...
export default function ClientDetail() {
  ...
  return (
    <div className="p-6 max-w-6xl mx-auto space-y-6 animate-fade-in">
      ...
      <div className="relative overflow-hidden bg-gray-900/80 border border-gray-800/50 rounded-2xl p-5 md:p-6">
          ...
          <div className="flex items-center gap-4 mt-3">
            ...
            <div className="flex-1 min-w-0">
              <div className="flex items-center gap-3">
                <h1 className="text-xl md:text-2xl font-bold text-white tracking-tight truncate">{client.name}</h1>
        ...
        <div className="flex flex-wrap gap-2 mt-4 pt-4 border-t border-gray-800/50">
          <button onClick={() => setTab('quotes')} className="px-3 py-1.5 bg-gradient-to-r from-purple-600 to-purple-500 hover:from-purple-500 hover:to-purple-400 rounded-xl text-xs font-medium text-white shadow-sm shadow-purple-500/20 transition-all">+ Quote</button>
          <button onClick={() => setTab('jobs')} className="px-3 py-1.5 bg-gradient-to-r from-blue-600 to-blue-500 hover:from-blue-500 hover:to-blue-400 rounded-xl text-xs font-medium text-white shadow-sm shadow-blue-500/20 transition-all">+ Job</button>
          <button onClick={() => setTab('invoices')} className="px-3 py-1.5 bg-gradient-to-r from-green-600 to-green-500 hover:from-green-500 hover:to-green-400 rounded-xl text-xs font-medium text-white shadow-sm shadow-green-500/20 transition-all">+ Invoice</button>
          <button onClick={() => {
            ...
            className="px-3 py-1.5 bg-white/5 hover:bg-white/10 border border-white/10 rounded-xl text-xs text-gray-300 transition-all" title="Copy client portal link">
            Portal Link
          </button>
        </div>
      </div>

      <div className="flex gap-0.5 border-b border-gray-800/50 overflow-x-auto whitespace-nowrap">
        {TABS.map(t => (
